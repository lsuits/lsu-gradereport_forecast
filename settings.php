...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_forecast_showrank', get_string('showrank', 'grades'), get_string('showrank_help', 'grades'), 0));
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_forecast_showfeedback', get_string('showfeedback', 'grades'), get_string('showfeedback_help', 'grades'), 1));
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_forecast_showlettergrade', get_string('showlettergrade', 'grades'), get_string('showlettergrade_help', 'grades'), 0));
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_forecast_showcontributiontocoursetotal',
